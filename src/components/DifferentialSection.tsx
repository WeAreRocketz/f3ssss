        ...
        <div className="max-w-5xl mx-auto space-y-16">
          ...
          <div className="bg-card rounded-3xl p-8 md:p-12 shadow-xl border border-border">
            <p className="text-base sm:text-lg md:text-xl text-center leading-relaxed mb-8 px-4">
              Nosso método combina <strong className="text-accent gold-shine-light">estratégia, execução e acompanhamento</strong>, 
              ...
              {differentials.map((item, index) => (
                ...
                >
                  <div className="flex-shrink-0">
                    <div className="w-16 h-16 rounded-2xl bg-accent/10 flex items-center justify-center shadow-[0_0_20px_rgba(197,162,83,0.2)] gold-shine-light">
                      <item.icon className="w-8 h-8 text-accent gold-shine-light" />
                    </div>
                  </div>
                  <div>
